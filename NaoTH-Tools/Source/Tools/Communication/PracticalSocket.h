...
public:
  ...
  /** Set to true to allow non-blocking on the calls to:
   * recv, accept
   */
...
protected:
  ...
  /**
   * Set whether this socket should be set to blocking (default) or non-blocking mode
   * ATTENTION: will only work for one recv, accept etc.
   */
  void setBlockingOnce(bool blocking);
};
