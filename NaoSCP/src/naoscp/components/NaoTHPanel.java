...
public class NaoTHPanel extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    cbCopyLola = new javax.swing.JCheckBox();
    ...
    cbCopyLola.setText("copyLolaAdaptor");
    cbCopyLola.addItemListener(new java.awt.event.ItemListener() {
      public void itemStateChanged(java.awt.event.ItemEvent evt) {
        cbCopyLolaItemStateChanged(evt);
      }
    });
  ...
  private void cbCopyLolaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbCopyLolaItemStateChanged
    // TODO add your handling code here:
  }//GEN-LAST:event_cbCopyLolaItemStateChanged
    ...
    public void checkFileAvailability()
    {
      ...
      if(new File(naothProjectFile, CopyConfigAction.localBinPath + "/lola_adaptor").exists()) {
          cbCopyLola.setEnabled(true);
      } else {
          cbCopyLola.setEnabled(false);
          cbCopyLola.setSelected(false);
      }
    ...
    public void setLibSelected()
    {
      cbCopyLib.setSelected(isLibEnabled());
    }

    public void setLolaSelected()
    {
      cbCopyLola.setSelected(isLolaEnabled());
    }

    public void setExecSelected()
    {
      cbCopyExe.setSelected(isExecEnabled());
    }

    public void setConfSelected()
    {
      cbCopyConfig.setSelected(isConfEnabled());
    }

    public boolean isLibEnabled()
    {
      return cbCopyLib.isEnabled();
    }

    public boolean isLolaEnabled()
    {
      return cbCopyLola.isEnabled();
    }

    public boolean isExecEnabled()
    {
      return cbCopyExe.isEnabled();
    }

    public boolean isConfEnabled()
    {
      return cbCopyConfig.isEnabled();
    }
        
    public boolean isLibSelected()
    {
      return cbCopyLib.isSelected();
    }

    public boolean isLolaSelected()
    {
      return cbCopyLola.isSelected();
    }

    public boolean isExecSelected()
    {
      return cbCopyExe.isSelected();
    }

    public boolean isConfSelected()
    {
      return cbCopyConfig.isSelected();
    }
  ...
  public CopyConfigAction getAction() throws NaoSCPException {
    ...
    public class CopyConfigAction {
        ...
        public void run(File deployDir) throws NaoSCPException 
        {
            ...
            if (cbCopyLola.isSelected()) {
                File src = new File(localBinDir, "lola_adaptor");
                File dst = new File(deployBinDir, "lola_adaptor");
                FileUtils.copyFiles(src, dst);
            }
            ...
            if(cbCopyConfig.isSelected())
            {
                ...
                try {
                    ...
                    */
                    if(playerNumberPanel.teamWasChanged()) {
                        playerNumberPanel.getTeamConfig().writeToFile(new File(privateFolder, "team.cfg"));
                    }
  ...
  private javax.swing.JCheckBox cbCopyLola;
