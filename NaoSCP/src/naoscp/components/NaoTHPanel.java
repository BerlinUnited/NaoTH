...
public class NaoTHPanel extends javax.swing.JPanel {
  ...
  private void initComponents()
  {
    ...
    cbEnableWifi = new javax.swing.JCheckBox();
    ...
    cbEnableWifi.setText("enableWifi");
  ...
  public CopyConfigAction getAction() throws NaoSCPException {
    ...
    public class CopyConfigAction {
        ...
        public void run(File deployDir) throws NaoSCPException 
        {
            ...
            File enableWifiFile = new File(deployDir, "enablewifi");
            File disableWifiFile = new File(deployDir, "disablewifi");
            enableWifiFile.delete();
            disableWifiFile.delete();
            try
            {
              if(cbEnableWifi.isSelected())
              {
                enableWifiFile.createNewFile();
              }
              else
              {
                disableWifiFile.createNewFile();
              }
            }
            catch(IOException ex)
            {
              throw new NaoSCPException("Could not write file to enable/disable wifi", ex);
            }
  ...
  private javax.swing.JCheckBox cbEnableWifi;
