...
import de.hu_berlin.informatik.ki.nao.dialogs.drawings.three_dimension.Drawable;
import de.hu_berlin.informatik.ki.nao.dialogs.drawings.three_dimension.Scene;
        ...
        implements ThreeDimensionSceneManager
{
  ...
  private String drawablePackageName = Drawable.class.getPackage().getName();
