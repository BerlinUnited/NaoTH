...
public class SPLMessage2018 extends SPLMessage {
    ...
    public SPLMessage2018()
    {
        user = TeamMessageOuterClass.BUUserTeamMessage.getDefaultInstance();
    }
    
    public SPLMessage2018(TeamMessageOuterClass.TeamMessage.Data msg) {
    ...
    public SPLMessage2018(ByteBuffer buffer) throws Exception {
        ...
        if (version != SPL_STANDARD_MESSAGE_STRUCT_VERSION) {
            throw new Exception("Wrong version: received " + version + ", but expected " + SPL_STANDARD_MESSAGE_STRUCT_VERSION);
    ...
    final public boolean extractCustomData(int size) {
