  ...
  implements SecondaryImageManager
{
  ...
  public JanusImage convertByteArrayToType(byte[] result) throws IllegalArgumentException
  {
    ...
    {
      Logger.getLogger(SecondaryImageManagerImpl.class.getName()).log(Level.SEVERE, "could not parse stream", ex);
    }catch(Exception ex)
    {
      Logger.getLogger(SecondaryImageManagerImpl.class.getName()).log(Level.SEVERE, "could not parse the image", ex);
    }
