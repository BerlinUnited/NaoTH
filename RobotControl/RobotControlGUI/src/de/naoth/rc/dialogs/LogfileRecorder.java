...
public class LogfileRecorder extends AbstractDialog
{
  ...
  private void initComponents() {
    ...
    txtTempFile.setText("/log/cognition.log");
    txtTempFile.setToolTipText("Path to store the logfile on the robot.");
    txtTempFile.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        txtTempFileActionPerformed(evt);
      }
    });
  ...
  private void txtTempFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTempFileActionPerformed
    // TODO add your handling code here:
  }//GEN-LAST:event_txtTempFileActionPerformed
