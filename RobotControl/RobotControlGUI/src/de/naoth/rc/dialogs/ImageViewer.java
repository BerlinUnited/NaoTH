...
public class ImageViewer extends AbstractDialog
{
  ...
  public void init()
  {
    ...
    secondaryImageCanvas = new ImagePanel();
    secondaryImageCanvas.setOpaque(false);
    secondaryImageCanvas.setDoubleBuffered(true);
    this.secondaryImagePanel.add(secondaryImageCanvas);
    this.secondaryImagePanel.setVisible(false);

    this.timestampOfTheLastImage = 0;

    this.drawingsListener = new DrawingsListener();
    this.imageListener = new ImageListener(imageCanvas);
    this.secondaryImageListener = new ImageListener(secondaryImageCanvas);
  ...
  private void initComponents()
  {
    ...
    secondaryImagePanel = new javax.swing.JPanel();
    ...
    cbSecondary = new javax.swing.JCheckBox();
    ...
    secondaryImagePanel.setBackground(java.awt.Color.gray);
    secondaryImagePanel.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.darkGray));
    secondaryImagePanel.setComponentPopupMenu(jPopupMenuImagePanel);
    secondaryImagePanel.setPreferredSize(new java.awt.Dimension(320, 240));

    javax.swing.GroupLayout secondaryImagePanelLayout = new javax.swing.GroupLayout(secondaryImagePanel);
    secondaryImagePanel.setLayout(secondaryImagePanelLayout);
    secondaryImagePanelLayout.setHorizontalGroup(
      secondaryImagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addGap(0, 0, Short.MAX_VALUE)
    );
    secondaryImagePanelLayout.setVerticalGroup(
      secondaryImagePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      .addGap(0, 132, Short.MAX_VALUE)
    );
    ...
    cbSecondary.setText("secondary");
    cbSecondary.setFocusable(false);
    cbSecondary.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
    cbSecondary.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
    jToolBar1.add(cbSecondary);
    ...
    layout.setHorizontalGroup(
      ...
      .addComponent(imagePanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 710, Short.MAX_VALUE)
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        ...
        .addContainerGap())
      .addComponent(secondaryImagePanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 710, Short.MAX_VALUE)
    );
    layout.setVerticalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        .addComponent(secondaryImagePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
  ...
  private void btReceiveImagesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btReceiveImagesActionPerformed
    ...
    this.secondaryImagePanel.setVisible(cbSecondary.isSelected());
    ...
    if (btReceiveImages.isSelected())
    {
      if (parent.checkConnected())
      {
        ...
        {
          secondardyImageManager.addListener(this.secondaryImageListener);
        }
      }
      else
      {
    ...
    else
    {
      ...
      secondardyImageManager.removeListener(this.secondaryImageListener);
    }
  ...
  private javax.swing.JCheckBox cbSecondary;
  ...
  private javax.swing.JPanel secondaryImagePanel;
  ...
  class ImageListener implements ObjectListener<JanusImage>
  {
    ...
    public ImageListener(ImagePanel canvas)
    {
      this.canvas = canvas;
    }
