...
/**
 * simgl example and test program
 */
final class Simgl {
    ...
    public static void main(String[] args) {
        ...
        final JFrame frame = new JFrame("simgl");
...
final class GLDraw implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {    	
    	...
    	String scenePath = System.getProperty("user.dir").replaceAll("\\\\", "/") + "/src/res/";
        ...
        camera = new Camera(Camera.FOCUS_MODE, camPos, new Point3f(0, 2, 0), new Point3f(0,1,0), 1, 1);
    }
