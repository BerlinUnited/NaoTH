...
public class GLData {
    ...
    public GLData(ArrayList<Point3f> glVertexData, ArrayList<Point3f> glNormalData, ArrayList<Point2f> glTextureData, ArrayList<Integer> glIndexData, BufferedImage textureImage){
    	
    	this.textureImage = loadTextureImage(textureImage);
    	
    	imageWidth = textureImage.getWidth();
    	imageHeight = textureImage.getHeight();
