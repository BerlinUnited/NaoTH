 ...
 */
public class Camera {
	final static char FLY_MODE = 1;
	final static char FOCUS_MODE = 2;
     ...
     */	
	public Camera(char mode, Point3f pos, Point3f focus, Point3f up, GLCanvas canvas) {
		this.canvas = canvas;
		...
		projectionMatrix.makePerspective(50, (float)canvas.getWidth() / (float)canvas.getHeight(), 0.1f, 1000f);
