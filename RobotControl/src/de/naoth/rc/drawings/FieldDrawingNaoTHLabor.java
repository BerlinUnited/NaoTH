 ...
 */
public class FieldDrawingNaoTHLabor implements Drawable{
   
    // ------------------------------
    // values taken from the NaoTHLabor scheme
    int xLength = 6000;
    int yLength = 3600;
    ...
    {
        // size of the carpet
        this.xFieldLength = 6800;
        this.yFieldLength = 4350;
    ...
    public FieldDrawingNaoTHLabor()
    {
        init();
    }
    
    @Override
    public String toString() { return "NaoTHLabor"; }
...
}//end class FieldDrawingsNaoTHLabor
