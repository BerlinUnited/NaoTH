...
//      }
   ...
   */
    ...
    private void jButtonPlayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPlayActionPerformed
      ...
      // play the motion
      sendCommand(new Command("SimpleMotionBehaviorControl:motion:play_editor_motionnet").addArg("on"));
      sendCommand(new Command("SimpleMotionBehaviorControl:motion:dead").addArg("off"));
    ...
    private void jButtonStopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonStopActionPerformed
      ...
      sendCommand(new Command("SimpleMotionBehaviorControl:motion:dead").addArg("on"));
      sendCommand(new Command("SimpleMotionBehaviorControl:motion:play_editor_motionnet").addArg("off"));
