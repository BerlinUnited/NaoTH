...
#define _StandingOnFeetDetector_H
...
BEGIN_DECLARE_MODULE(StandingOnFeetDetector)
...
END_DECLARE_MODULE(StandingOnFeetDetector)


class StandingOnFeetDetector: private StandingOnFeetDetectorBase
{
public:
    StandingOnFeetDetector();
    ~StandingOnFeetDetector();
