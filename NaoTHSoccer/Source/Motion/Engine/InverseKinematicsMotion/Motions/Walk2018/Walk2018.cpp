...
RotationMatrix Walk2018::calculateBodyRotation(const FeetPose& feet, double pitch) const
{
...
Pose3D Walk2018::calculateStableCoMByFeet(FeetPose feet, double pitch) const
{
