...
public:
  ...
  bool rotationStabilizeRC16(//const InertialModel& theInertialModel,
  ...
  bool rotationStabilizeNewIMU(//const InertialModel& theInertialModel,
  ...
  bool rotationStabilize(const InertialModel& theInertialModel,
    const GyrometerData& theGyrometerData,
    double timeDelta,
    InverseKinematic::HipFeetPose& p, Vector2d rotationP, Vector2d rotationVelocityP, Vector2d rotationD);
