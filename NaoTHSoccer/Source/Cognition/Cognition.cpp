...
#include "Modules/VisualCortex/FieldDetector/FieldAreaDetector.h"
...
#include "Modules/Modeling/SelfLocator/MonteCarloSelfLocator/MonteCarloSelfLocator2018.h"
...
void Cognition::init(naoth::ProcessInterface& platformInterface, const naoth::PlatformBase& platform)
{
  ...
  */
  ...
  REGISTER_MODULE(FieldAreaDetector);
  ...
  REGISTER_MODULE(MonteCarloSelfLocator2018);
