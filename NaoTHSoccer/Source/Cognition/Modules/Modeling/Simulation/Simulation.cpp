...
void Simulation::calculateAction(GoalModel::Goal &oppGoalModel, std::vector<RingBufferWithSum<double, 30> > &buffer) const
{
  ...
  DEBUG_REQUEST("Simulation:draw_action_points:global",
    FIELD_DRAWING_CONTEXT;
    PEN("000000", 1);
  ...
  DEBUG_REQUEST("Simulation:draw_lines:goal_line_global",
    FIELD_DRAWING_CONTEXT;
  ...
  DEBUG_REQUEST("Simulation:draw_lines:shootline_global",
    FIELD_DRAWING_CONTEXT;
  ...
  DEBUG_REQUEST("Simulation:draw_action_points:best_action",
    FIELD_DRAWING_CONTEXT;
    PEN("F0F0F0", 1);
    Vector2d actionGlobal = getRobotPose() * action_local[best_action].target;
    CIRCLE(actionGlobal.x, actionGlobal.y, 50);
