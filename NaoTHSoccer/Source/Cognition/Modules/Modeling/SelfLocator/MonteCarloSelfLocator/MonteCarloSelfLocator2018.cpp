/**
* @file MonteCarloSelfLocator2018.cpp
*
* @author <a href="mailto:mellmann@informatik.hu-berlin.de">Heinrich Mellmann</a>
* Implementation of class MonteCarloSelfLocator2018
*/

#include "MonteCarloSelfLocator2018.h"
...
MonteCarloSelfLocator2018::MonteCarloSelfLocator2018() 
  :
  state(LOCALIZE),
  lastState(LOCALIZE),
  islocalized(false),
...
void MonteCarloSelfLocator2018::execute()
{
  // reset
  updatedByGoalPosts = false;
...
void MonteCarloSelfLocator2018::resetLocator()
{
...
void MonteCarloSelfLocator2018::updateByGoalPosts(const GoalPercept& goalPercept, SampleSet& sampleSet) const
{
...
void MonteCarloSelfLocator2018::updateBySingleGoalPost(const GoalPercept::GoalPost& seenPost, SampleSet& sampleSet) const
{
...
void MonteCarloSelfLocator2018::updateByCompas(SampleSet& sampleSet) const
{
  for(size_t i = 0; i < sampleSet.size(); i++) {
...
void MonteCarloSelfLocator2018::updateByLinePoints(const LineGraphPercept& lineGraphPercept, SampleSet& sampleSet) const
{
...
void MonteCarloSelfLocator2018::updateByLines(const LinePercept& linePercept, SampleSet& sampleSet) const
{
  const double cameraHeight = getCameraMatrix().translation.z;
  const double sigmaDistance = parameters.goalPostSigmaDistance;
  const double sigmaAngle = parameters.goalPostSigmaAngle;
  ...
  DEBUG_REQUEST("MCSL:plots",
    PLOT("MonteCarloSelfLocator2018:shortestLine", shortestLine);
  );
  */
}//end updateByLinesTable


void MonteCarloSelfLocator2018::updateByShortLines(const LinePercept& linePercept, SampleSet& sampleSet) const
{
  const double cameraHeight = getCameraMatrix().translation.z;
  const double sigmaDistance = parameters.goalPostSigmaDistance;
  const double sigmaAngle = parameters.goalPostSigmaAngle;
...
void MonteCarloSelfLocator2018::updateByMiddleCircle(const LinePercept& linePercept, SampleSet& sampleSet) const
{
...
void MonteCarloSelfLocator2018::updateBySidePositions(SampleSet& sampleSet) const
{
  double offserY = 0;
...
void MonteCarloSelfLocator2018::updateByStartPositions(SampleSet& sampleSet) const
{
  double offserY = 0;
  Vector2d startLeft(getFieldInfo().xPosOwnPenaltyArea, getFieldInfo().yLength/2.0 - offserY);
  Vector2d endLeft(                               -500, getFieldInfo().yLength/2.0 - offserY);
...
void MonteCarloSelfLocator2018::updateByOwnHalfLookingForward(SampleSet& sampleSet) const
{
  for(size_t s=0; s < sampleSet.size(); s++)
  {
    Sample& sample = sampleSet[s];
...
void MonteCarloSelfLocator2018::updateByOwnHalf(SampleSet& sampleSet) const
{
  for(size_t s=0; s < sampleSet.size(); s++)
  {
    Sample& sample = sampleSet[s];
...
void MonteCarloSelfLocator2018::updateByOppHalf(SampleSet& sampleSet) const
{
  for(size_t s=0; s < sampleSet.size(); s++)
  {
    Sample& sample = sampleSet[s];
...
void MonteCarloSelfLocator2018::updateByGoalBox(SampleSet& sampleSet) const
{
...
void MonteCarloSelfLocator2018::updateByOldPose(SampleSet& sampleSet) const
{     
...
/*
void MonteCarloSelfLocator2018::updateByGoalModel(SampleSet& sampleSet) const
{
...
void MonteCarloSelfLocator2018::updateByPose(SampleSet& sampleSet, Pose2D pose, double sigmaDistance, double /*sigmaAngle*/) const
{
  for (size_t j = 0; j < sampleSet.size(); j++)
  {   
...
void MonteCarloSelfLocator2018::updateStatistics(SampleSet& sampleSet)
{
  ...
  PLOT("MonteCarloSelfLocator2018:w_average",avg);
  PLOT("MonteCarloSelfLocator2018:cross_entropy",avg);
...
void MonteCarloSelfLocator2018::resampleSimple(SampleSet& sampleSet, int number) const
{
  sampleSet.normalize();
...
//Metropolis Hastings
void MonteCarloSelfLocator2018::resampleMH(SampleSet& sampleSet)
{
...
int MonteCarloSelfLocator2018::resampleSUS(SampleSet& sampleSet, int n) const
{
  SampleSet oldSampleSet = sampleSet;
  oldSampleSet.normalize(parameters.resamplingThreshhold);
...
void MonteCarloSelfLocator2018::resampleGT07(SampleSet& sampleSet, bool noise) const
{
...
int MonteCarloSelfLocator2018::sensorResetBySensingGoalModel(SampleSet& sampleSet, int n) const
{
...
void MonteCarloSelfLocator2018::calculatePose(SampleSet& sampleSet)
{
  /************************************
   * STEP V: clustering
   ************************************/
...
void MonteCarloSelfLocator2018::drawPosition() const
{
  FIELD_DRAWING_CONTEXT;
...
void MonteCarloSelfLocator2018::draw_sensor_belief() const
{
