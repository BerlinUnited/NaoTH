...
void AdaptiveAutoExposure::execute()
{
    ...
    {
        if(executeBottom) {
            getCameraSettingsRequest().v5_autoExpositionAlgorithm = 0;
        }
        if(executeTop) {
            getCameraSettingsRequestTop().v5_autoExpositionAlgorithm = 0;
        }
    }
    else
    {
        ...
        if(executeBottom) {
            getCameraSettingsRequest().v5_autoExpositionAlgorithm = 1;
        }
        if(executeTop) {
            getCameraSettingsRequestTop().v5_autoExpositionAlgorithm = 1;            
        }
