...
void PathSymbols::registerSymbols(xabsl::Engine& engine)
{
  ...
  engine.registerEnumElement("path2018.routine", "path2018.routine.move_around_ball_old", static_cast<int>(PathModel::PathPlanner2018Routine::MOVE_AROUND_BALL_OLD));
