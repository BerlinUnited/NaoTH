#ifndef TFLITEMODEL32_NAOTH_H
#define TFLITEMODEL32_NAOTH_H
...
class TFLiteModelNaoTH32 : public AbstractCNNFinder
{
public:
    TFLiteModelNaoTH32(std::string file, bool has_radius = false, bool has_center = false, bool has_confidence = true) :
      name(file),
...
private:
    ...
    bool has_confidence;
    int numThreads = 2;
    std::vector<int> input_dims = {1, 32, 32, 3};
