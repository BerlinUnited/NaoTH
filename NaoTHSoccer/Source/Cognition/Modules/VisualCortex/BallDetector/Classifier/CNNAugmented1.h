#ifndef _CNNAugmented1_H_
#define _CNNAugmented1_H_
...
class CNNAugmented1 : public AbstractCNNClassifier {


public:
	CNNAugmented1(){out.open("example.txt");}

	~CNNAugmented1(){out.close();}
