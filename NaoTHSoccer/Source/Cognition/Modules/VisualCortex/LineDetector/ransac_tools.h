...
public:
  ...
  bool find_best_model(LineModel& bestModel, const std::vector<Edgel>& edgels) const;
...
public:
  ...
  bool find_best_model(CircleModel& best_model, const std::vector<Edgel>& edgels) const;
