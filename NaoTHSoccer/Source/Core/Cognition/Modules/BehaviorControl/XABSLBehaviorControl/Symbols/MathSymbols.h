...
* @author Max Risler
*/ 
class MathSymbols: public MathSymbolsBase
{
public:
  /*
  * Constructor.
...
private:
  ...
  static MathSymbols* theInstance; /**< Points to the only instance of this class in this process or is 0 if there is none. */
