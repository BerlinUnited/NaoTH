...
#include "XABSLBehaviorControl2012.h"
...
XABSLBehaviorControl2012::XABSLBehaviorControl2012()
  : 
...
#define REGISTER_MODULE(module, enable) \
  ...
  // init symbols
  REGISTER_MODULE(BallSymbols2012, true);
  REGISTER_MODULE(GameSymbols2012, true);
  REGISTER_MODULE(MotionSymbols2012, true);
  REGISTER_MODULE(TeamSymbols2012, true);
  REGISTER_MODULE(SensorSymbols2012, true);
  REGISTER_MODULE(MathSymbols2012, true);
  REGISTER_MODULE(GoalSymbols2012, true);
  REGISTER_MODULE(LedSymbols2012, true);
  REGISTER_MODULE(SelflocSymbols2012, true);
  REGISTER_MODULE(OdometrySymbols2012, true);
  REGISTER_MODULE(FieldSymbols2012, true);
  REGISTER_MODULE(StrategySymbols2012, true);
  REGISTER_MODULE(SoundSymbols2012, true);
  REGISTER_MODULE(LineSymbols2012, true);
...
void XABSLBehaviorControl2012::reloadBehaviorFromFile(std::string file, std::string agent)
{
  // clear old status
  ...
  delete theEngine;
  // create a new engine 
  theEngine = xabsl::EngineFactory<XABSLBehaviorControl2012>::create(theErrorHandler, this->xabslTime); 
  //
...
void XABSLBehaviorControl2012::execute()
{
...
void XABSLBehaviorControl2012::draw()
{
...
void XABSLBehaviorControl2012::registerXABSLSymbols()
{
  if(theEngine != NULL)
  {
    XABSL_REGISTER_SYMBOLS(BallSymbols2012);
    XABSL_REGISTER_SYMBOLS(GameSymbols2012);
    XABSL_REGISTER_SYMBOLS(MotionSymbols2012);
    XABSL_REGISTER_SYMBOLS(TeamSymbols2012);
    XABSL_REGISTER_SYMBOLS(SensorSymbols2012);
    XABSL_REGISTER_SYMBOLS(MathSymbols2012);
    XABSL_REGISTER_SYMBOLS(GoalSymbols2012);
    XABSL_REGISTER_SYMBOLS(LedSymbols2012);
    XABSL_REGISTER_SYMBOLS(SelflocSymbols2012);
    XABSL_REGISTER_SYMBOLS(OdometrySymbols2012);
    XABSL_REGISTER_SYMBOLS(FieldSymbols2012);
    XABSL_REGISTER_SYMBOLS(StrategySymbols2012);
    XABSL_REGISTER_SYMBOLS(SoundSymbols2012);
    XABSL_REGISTER_SYMBOLS(LineSymbols2012);
  }//end if
}//end registerXABSLSymbols


void XABSLBehaviorControl2012::updateXABSLSymbols()
{
  if(theEngine != NULL)
  {
    theSelflocSymbols2012->execute();
    theSensorSymbols2012->execute();
    theBallSymbols2012->execute();
    theOdometrySymbols2012->execute();
    theMotionSymbols2012->execute();
    theLineSymbols2012->execute();
    theStrategySymbols2012->execute();
  }//end if
}//end updateXABSLSymbols

void XABSLBehaviorControl2012::updateOutputSymbols()
{
  if(theEngine != NULL)
  {
    theMotionSymbols2012->getModuleT()->updateOutputSymbols();
  }
...
MyErrorHandler2012::MyErrorHandler2012(std::ostream& out)
  : out(out)
{
}

void MyErrorHandler2012::printError(const char* txt)
{
  out << "XABSL error: " << txt << std::endl;
  std::cerr << "XABSL error: " << txt << std::endl;
}

void MyErrorHandler2012::printMessage(const char* txt)
{
  out << "XABSL message: " << txt << std::endl;
  std::cout << "XABSL message: " << txt << std::endl;
}

MyErrorHandler2012::~MyErrorHandler2012()
{
}


void XABSLBehaviorControl2012::executeDebugCommand(
...
void XABSLBehaviorControl2012::fillActiveOptions(naothmessages::BehaviorStatus &status)
{
...
void XABSLBehaviorControl2012::fillAction(const xabsl::Action* source, naothmessages::XABSLAction* dest)
{
...
void XABSLBehaviorControl2012::fillRegisteredSymbols(naothmessages::BehaviorStatus &status)
{
  /*******************************************************************
   * input symbols
   *******************************************************************/
