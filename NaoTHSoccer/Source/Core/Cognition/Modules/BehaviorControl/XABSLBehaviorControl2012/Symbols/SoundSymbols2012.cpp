/**
 * @file SoundSymbols2012.cpp
 *
 * Implementation of class SoundSymbols2012
 */


#include "SoundSymbols2012.h"

void SoundSymbols2012::registerSymbols(xabsl::Engine& engine)
{
...
SoundSymbols2012* SoundSymbols2012::theInstance = NULL;

void SoundSymbols2012::execute()
{
}


void SoundSymbols2012::setSoundRequest(int value)
{
  if(value == 0)
  {
...
int SoundSymbols2012::getSoundRequest()
{
