/* 
 * File:   SensorSymbols2012.h
 * Author: thomas
 *
 * Created on 9. April 2009, 18:10
 */

#ifndef _SensorSymbols2012_H
#define _SensorSymbols2012_H
...
BEGIN_DECLARE_MODULE(SensorSymbols2012)
  ...
  REQUIRE(ButtonData)
END_DECLARE_MODULE(SensorSymbols2012)

class SensorSymbols2012: public SensorSymbols2012Base
{
public:
...
private:
  ...
  static SensorSymbols2012* theInstance;
