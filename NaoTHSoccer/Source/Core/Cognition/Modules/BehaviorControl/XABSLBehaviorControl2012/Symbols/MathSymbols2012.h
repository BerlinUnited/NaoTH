/** 
* @file MathSymbols2012.h
*
* Declaration of class MathSymbols2012.
*
* @author Max Risler
*/

#ifndef __MathSymbols2012_h_
#define __MathSymbols2012_h_
...
BEGIN_DECLARE_MODULE(MathSymbols2012)
END_DECLARE_MODULE(MathSymbols2012)
...
* @author Max Risler
*/ 
class MathSymbols2012: public MathSymbols2012Base
{
public:
  /*
  * Constructor.
...
private:
  ...
  static MathSymbols2012* theInstance; /**< Points to the only instance of this class in this process or is 0 if there is none. */
