/**
 * @file: TeamSymbols2012.cpp
 * @author: <a href="mailto:scheunem@informatik.hu-berlin.de">Marcus Scheunemann</a>
 *
 * First created on 9. April 2009, 18:10
 */

#include "TeamSymbols2012.h"

void TeamSymbols2012::registerSymbols(xabsl::Engine& engine)
{
...
TeamSymbols2012* TeamSymbols2012::theInstance = NULL;

void TeamSymbols2012::execute()
{
}

double TeamSymbols2012::getTeamMembersAliveCount()
{
  int counter = 0;
...
bool TeamSymbols2012::getWasStriker()
{
  return theInstance->playerInfo.isPlayingStriker;
}//end getWasStriker

void TeamSymbols2012::setWasStriker(bool striker)
{
  theInstance->playerInfo.isPlayingStriker = striker;
}//end setWasStriker

bool TeamSymbols2012::calculateIfStriker()
{
...
bool TeamSymbols2012::calculateIfStrikerByTimeToBall()
{
  TeamMessage const& tm = theInstance->teamMessage;
...
TeamSymbols2012::~TeamSymbols2012()
{
}

/** the robot which is closest to own goal is defined as the last one */
bool TeamSymbols2012::calculateIfTheLast()
{
  TeamMessage const& tm = theInstance->teamMessage;
