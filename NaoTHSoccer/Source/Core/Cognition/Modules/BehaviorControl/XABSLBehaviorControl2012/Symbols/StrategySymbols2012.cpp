...
void StrategySymbols2012::registerSymbols(xabsl::Engine& engine)
{
  ...
  DEBUG_REQUEST_REGISTER("XABSL:StrategySymbols2012:draw_attack_direction","draw the attack direction", false);

  DEBUG_REQUEST_REGISTER("XABSL:StrategySymbols2012:draw_simpleDefenderPose","draw the position of the defender", false);
...
StrategySymbols2012* StrategySymbols2012::theInstance = NULL;


void StrategySymbols2012::execute()
{
  ...
  DEBUG_REQUEST("XABSL:StrategySymbols2012:draw_attack_direction",
  ...
  DEBUG_REQUEST("XABSL:StrategySymbols2012:draw_simpleDefenderPose",
    FIELD_DRAWING_CONTEXT;
    PEN("FF0000", 50);
...
//int StrategySymbols2012::getSituationStatusId(){ 
//	return (int)(theInstance->situationStatus.id); 
//}

bool StrategySymbols2012::getSituationStatusOwnHalf(){ 
	return (theInstance->getSituationStatus().ownHalf); 
}

void StrategySymbols2012::setSituationStatusOwnHalf(bool ownHalf){ 
	theInstance->getSituationStatus().ownHalf = ownHalf; 
}


bool StrategySymbols2012::getSituationStatusOppHalf(){ 
	return (theInstance->getSituationStatus().oppHalf); 
}

void StrategySymbols2012::setSituationStatusOppHalf(bool oppHalf){ 
	theInstance->getSituationStatus().oppHalf = oppHalf; 
}

bool StrategySymbols2012::getReactiveBallModelNeeded()
{
  return (theInstance->getSituationStatus().reactiveBallModelNeeded);
}

void StrategySymbols2012::setReactiveBallModelRequested(bool reactiveNeeded)
{
  theInstance->getSituationStatus().reactiveBallModelNeeded = reactiveNeeded;
}

Vector2<double> StrategySymbols2012::calculateGoalieGuardPosition()
{
  Vector2<double> ballPos = robotPose*ballModel.futurePosition[5];

  double groundLineDistance = 500.0;
  MODIFY("StrategySymbols2012:groundLineDistance", groundLineDistance);
  // apply clipping
...
Vector2<double> StrategySymbols2012::calculatePenaltyGoalieGuardPosition()
{
...
double StrategySymbols2012::goalieGuardPositionX()
{
  return theInstance->calculateGoalieGuardPosition().x;
}

double StrategySymbols2012::goalieGuardPositionY()
{
  return theInstance->calculateGoalieGuardPosition().y;
}

double StrategySymbols2012::penaltyGoalieGuardPositionX()
{
  return theInstance->calculatePenaltyGoalieGuardPosition().x;
}

double StrategySymbols2012::penaltyGoalieGuardPositionY()
{
  return theInstance->calculatePenaltyGoalieGuardPosition().y;
}

bool StrategySymbols2012::getApproachingWithRightFoot()
{
...
double StrategySymbols2012::getOwnClosestToBallNumber()
{
  return theInstance->playersModel.ownClosestToBall.number;
}

double StrategySymbols2012::getOwnClosestToBallTimeSinceLastSeen()
{
  return theInstance->frameInfo.getTimeSince(
    theInstance->playersModel.ownClosestToBall.frameInfoWhenWasSeen.getTime());
}

double StrategySymbols2012::getOwnClosestToBallDistanceToBall()
{
  return (theInstance->ballModel.position - theInstance->playersModel.ownClosestToBall.pose.translation).abs();
}

Pose2D StrategySymbols2012::calculateSimpleDefensePose()
{
  Pose2D defPose;
...
bool StrategySymbols2012::calculateSetPiecePose()
{
  goalKickPlayer = 0;
...
void StrategySymbols2012::testArrangeRobots()
{
  std::vector<Vector2<double> > setPiecePoints;
  //input of positions
...
void StrategySymbols2012::arrangeRobots(
...
bool StrategySymbols2012::setpieceParticipation()
{
...
*/
double StrategySymbols2012::circleX()
{  
...
*/
double StrategySymbols2012::circleY()
{
