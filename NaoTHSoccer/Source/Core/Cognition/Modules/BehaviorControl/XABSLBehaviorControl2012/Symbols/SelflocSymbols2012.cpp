/**
* @file SelflocSymbols2012.cpp
*
* @author <a href="mailto:martius@informatik.hu-berlin.de">Martin Martius</a>
* Implementation of class SelflocSymbols2012
*/

#include "SelflocSymbols2012.h"

SelflocSymbols2012* SelflocSymbols2012::theInstance = NULL;

void SelflocSymbols2012::registerSymbols(xabsl::Engine& engine)
{
...
void SelflocSymbols2012::execute()
{
...
double SelflocSymbols2012::getRel2fieldX()
{
...
double SelflocSymbols2012::getRel2fieldY()
{
  Pose2D result = theInstance->robotPose;
  Vector2<double> add;
...
double SelflocSymbols2012::getFieldToRelativeX()
{
  return (theInstance->robotPose/theInstance->parameterVector).x;
}//end getFieldToRelativeX

double SelflocSymbols2012::getFieldToRelativeY()
{
