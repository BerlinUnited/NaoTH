/** 
* @file MathSymbols2012.cpp
*
* Implementation of class MathSymbols2012
*
* @author Max Risler
*/

#include "MathSymbols2012.h"

MathSymbols2012* MathSymbols2012::theInstance = 0;

void MathSymbols2012::registerSymbols(xabsl::Engine& engine)
{
  // "atan2"
...
double MathSymbols2012::getSgn()
{
  return theInstance->sgnValue > 0 ? 1 : -1;
}

double MathSymbols2012::getAbs()
{
  return fabs(theInstance->absValue);
}

double MathSymbols2012::getMin()
{
...
double MathSymbols2012::getAtan2()
{
  return toDegrees(atan2(theInstance->atan2y,theInstance->atan2x));
}

double MathSymbols2012::getMax()
{
...
double MathSymbols2012::getVectorAbs()
{
