...
StrategySymbols2011* StrategySymbols2011::theInstance = NULL;


void StrategySymbols2011::execute()
{
...
Vector2<double> StrategySymbols2011::calculateGoalieGuardPosition()
{
...
Vector2<double> StrategySymbols2011::calculatePenaltyGoalieGuardPosition()
{
...
double StrategySymbols2011::goalieGuardPositionX()
{
  return theInstance->calculateGoalieGuardPosition().x;
}

double StrategySymbols2011::goalieGuardPositionY()
{
  return theInstance->calculateGoalieGuardPosition().y;
}

double StrategySymbols2011::penaltyGoalieGuardPositionX()
{
  return theInstance->calculatePenaltyGoalieGuardPosition().x;
}

double StrategySymbols2011::penaltyGoalieGuardPositionY()
{
...
double StrategySymbols2011::getOwnClosestToBallNumber()
{
  return theInstance->playersModel.ownClosestToBall.number;
}

double StrategySymbols2011::getOwnClosestToBallTimeSinceLastSeen()
{
  return theInstance->frameInfo.getTimeSince(
    theInstance->playersModel.ownClosestToBall.frameInfoWhenWasSeen.getTime());
}

double StrategySymbols2011::getOwnClosestToBallDistanceToBall()
{
...
bool StrategySymbols2011::calculateSetPiecePose()
{
  goalKickPlayer = 0;
...
void StrategySymbols2011::testArrangeRobots()
{
  std::vector<Vector2<double> > setPiecePoints;
  //input of positions
...
void StrategySymbols2011::arrangeRobots(
...
bool StrategySymbols2011::setpieceParticipation()
{
  return theInstance->calculateSetPiecePose();
}

double StrategySymbols2011::calculateAttackDirection()
{
...
Vector2<double> StrategySymbols2011::calculatePlayerPotentialField(const Vector2<double>& player, const Vector2<double>& ball)
{
...
*/
double StrategySymbols2011::circleX()
{  
...
*/
double StrategySymbols2011::circleY()
{
