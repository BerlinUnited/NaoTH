...
void LedSymbols2011::registerSymbols(xabsl::Engine& engine)
{
...
LedSymbols2011* LedSymbols2011::theInstance = NULL;

void LedSymbols2011::execute()
{
}


void LedSymbols2011::setRightEar(double id)
{
...
double LedSymbols2011::getRightEar()
{
  return theInstance->lastREar;
}

void LedSymbols2011::setLeftEar(double id)
{
  id = floor(id + 0.5);
  if (id <= 10.0)
  {
...
double LedSymbols2011::getLeftEar()
{
  return theInstance->lastLEar;
}

void LedSymbols2011::setEye(LEDData::MultiLEDID from, LEDData::MultiLEDID to, int value)
{
...
void LedSymbols2011::setLeftEye(int value)
{
...
int LedSymbols2011::getRightEye()
{
  return theInstance->lastREye;
}

void LedSymbols2011::setRightEye(int value)
{
