...
void SelflocSymbols2011::registerSymbols(xabsl::Engine& engine)
{
...
void SelflocSymbols2011::execute()
{
...
double SelflocSymbols2011::getRel2fieldX()
{
...
double SelflocSymbols2011::getRel2fieldY()
{
  Pose2D result = theInstance->robotPose;
  Vector2<double> add;
...
double SelflocSymbols2011::getFieldToRelativeX()
{
  return (theInstance->robotPose/theInstance->parameterVector).x;
}//end getFieldToRelativeX

double SelflocSymbols2011::getFieldToRelativeY()
{
