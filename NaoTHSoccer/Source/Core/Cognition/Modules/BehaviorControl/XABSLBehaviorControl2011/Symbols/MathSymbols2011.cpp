...
void MathSymbols2011::registerSymbols(xabsl::Engine& engine)
{
  // "atan2"
...
double MathSymbols2011::getSgn()
{
  return theInstance->sgnValue > 0 ? 1 : -1;
}

double MathSymbols2011::getAbs()
{
  return fabs(theInstance->absValue);
}

double MathSymbols2011::getMin()
{
...
double MathSymbols2011::getAtan2()
{
  return toDegrees(atan2(theInstance->atan2y,theInstance->atan2x));
}

double MathSymbols2011::getMax()
{
...
double MathSymbols2011::getVectorAbs()
{
