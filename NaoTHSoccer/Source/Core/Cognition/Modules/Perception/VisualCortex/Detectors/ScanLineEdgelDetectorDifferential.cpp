...
double ScanLineEdgelDetector::getPointsAngle(const Vector2i& point) const
{
...
double ScanLineEdgelDetector::calculateMeanAngle(double angle1,double angle2) const
{
  /*
  Vector2d a (1,0);
  a.rotate(angle1);
