...
{
  DEBUG_REQUEST_REGISTER("Vision:Detectors:LineGraphProvider:edgel_pairs", "mark the edgels on the image", false);
  DEBUG_REQUEST_REGISTER("Vision:Detectors:LineGraphProvider:draw_neighbors", "mark the edgels on the image", false);
  DEBUG_REQUEST_REGISTER("Vision:Detectors:LineGraphProvider:draw_neighbors_field", "mark the edgels on the image", false);

  DEBUG_REQUEST_REGISTER("Vision:Detectors:LineGraphProvider:edgel_cluster", "mark the edgels on the image", false);
  DEBUG_REQUEST_REGISTER("Vision:Detectors:LineGraphProvider:draw_lines", "draw the esimated lines in the image", false);

  DEBUG_REQUEST_REGISTER("Vision:Detectors:LineGraphProvider:draw_compas", "draw compas direcion based on the edgel directions", false);
}
...
void LineGraphProvider::execute(CameraInfo::CameraID id)
{
  ...
  DEBUG_REQUEST("Vision:Detectors:LineGraphProvider:edgel_pairs",
  ...
  DEBUG_REQUEST("Vision:Detectors:LineGraphProvider:draw_neighbors",
    CANVAS(((cameraID == CameraInfo::Top)?"ImageTop":"ImageBottom"));
  ...
  DEBUG_REQUEST("Vision:Detectors:LineGraphProvider:draw_neighbors_field",
  ...
  DEBUG_REQUEST("Vision:Detectors:LineGraphProvider:draw_compas",
