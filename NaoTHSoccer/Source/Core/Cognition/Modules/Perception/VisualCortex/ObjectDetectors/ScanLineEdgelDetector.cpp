...
bool ScanLineEdgelDetector::isFieldColor(const Pixel& pixel)
{
  return getColorTable64().getColorClass(pixel) == ColorClasses::green || getFieldColorPercept().isFieldColor(pixel);
}
