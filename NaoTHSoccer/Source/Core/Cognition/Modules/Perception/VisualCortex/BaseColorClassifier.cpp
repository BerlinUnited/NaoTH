  ...
  whiteLinesColorCalibrator("WhiteLines", ColorClasses::white)
{
  ...
  DEBUG_REQUEST_REGISTER("ImageProcessor:BaseColorClassifier:calibration_areas:show_yellow_goal_area", " ", false);
  DEBUG_REQUEST_REGISTER("ImageProcessor:BaseColorClassifier:calibration_areas:show_pinkWaistBand_area", " ", false);
...
{
  DEBUG_REQUEST("ImageProcessor:BaseColorClassifier:calibration_areas:show_line_area",
    whiteLinesColorCalibrator.drawCalibrationAreaRects();
  );

  DEBUG_REQUEST("ImageProcessor:BaseColorClassifier:calibration_areas:show_ball_area",
    orangeBallColorCalibrator.drawCalibrationAreaRects();  
  );

  DEBUG_REQUEST("ImageProcessor:BaseColorClassifier:calibration_areas:show_blue_goal_area",
    blueGoalColorCalibrator.drawCalibrationAreaRects();
  );

  DEBUG_REQUEST("ImageProcessor:BaseColorClassifier:calibration_areas:show_yellow_goal_area",
    yellowGoalColorCalibrator.drawCalibrationAreaRects();
  );

  DEBUG_REQUEST("ImageProcessor:BaseColorClassifier:calibration_areas:show_pinkWaistBand_area",
    pinkWaistBandColorCalibrator.drawCalibrationAreaRects();
  );

  DEBUG_REQUEST("ImageProcessor:BaseColorClassifier:calibration_areas:show_blueWaistBand_area",
