...
#define MAX_FIELD_COLOR_Y_CHANNEL_DIST 96
#define MAX_FIELD_COLOR_CB_CHANNEL_DIST 36
#define MAX_FIELD_COLOR_CR_CHANNEL_DIST 36

#define MIN_FIELD_COLOR_Y_LEVEL 5
#define MIN_FIELD_COLOR_CB_LEVEL 0
#define MIN_FIELD_COLOR_CR_LEVEL 0
