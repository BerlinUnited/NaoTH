...
class DebugBottomImageDrawings : public naoth::Singleton<DebugBottomImageDrawings>, public naoth::DrawingCanvas
{
protected:
...
#ifdef DEBUG
#define CIRCLE_PX(...) DebugBottomImageDrawings::getInstance().drawCircleToImage(__VA_ARGS__)
#define RECT_PX(...) DebugBottomImageDrawings::getInstance().drawRectToImage(__VA_ARGS__)
#define LINE_PX(...) DebugBottomImageDrawings::getInstance().drawLineToImage(__VA_ARGS__)
#define POINT_PX(...) DebugBottomImageDrawings::getInstance().drawPointToImage(__VA_ARGS__)
#else
...
class DebugTopImageDrawings : public naoth::Singleton<DebugTopImageDrawings>, public naoth::DrawingCanvas
{
protected:
  friend class naoth::Singleton<DebugTopImageDrawings>;
  DebugTopImageDrawings()
  : 
    pixels(width()*height()),
    coordinates(width()*height()),
    numberOfPoints(0)
