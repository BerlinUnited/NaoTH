 ...
 * Declaration/Implementation of class Assoziation
 */
 ...
 * Thereby, each element a or b can have only one association.
 * If a new association for pair (a,b) is added, all old associations for a and b are removed.
 */
class Assoziation
{
public:
