...
_PLOTITEM_PLOTTYPE = descriptor.EnumDescriptor(
  name='PlotType',
...
_STOPWATCHES = descriptor.Descriptor(
  name='Stopwatches',
...
_PLOTITEM = descriptor.Descriptor(
  name='PlotItem',
...
_PLOTSTROKE2D = descriptor.Descriptor(
  name='PlotStroke2D',
...
_XABSLSYMBOL = descriptor.Descriptor(
  name='XABSLSymbol',
...
_XABSLACTIVEOPTIONSPARSE = descriptor.Descriptor(
...
_XABSLACTIONSPARSE = descriptor.Descriptor(
...
_SYMBOLVALUELIST_DOUBLESYMBOL = descriptor.Descriptor(
  name='DoubleSymbol',
...
_BEHAVIORSTATESPARSE = descriptor.Descriptor(
...
_BEHAVIORSTATECOMPLETE_ENUMTYPE_ELEMENT = descriptor.Descriptor(
  name='Element',
...
_MODULELIST = descriptor.Descriptor(
  name='ModuleList',
...
_DEBUGREQUEST_ITEM = descriptor.Descriptor(
  name='Item',
...
_FEATUREKEYPOINT = descriptor.Descriptor(
...
_FEATUREDETECTIONRESULT = descriptor.Descriptor(
...
_SINGLEDESCRIPTOR = descriptor.Descriptor(
...
_FEATURECLASS = descriptor.Descriptor(
  name='FeatureClass',
...
_FEATURETABLE = descriptor.Descriptor(
  name='FeatureTable',
