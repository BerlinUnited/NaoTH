#ifndef _CNN_aug2_full_conv_H_
#define _CNN_aug2_full_conv_H_
...
class CNN_aug2_full_conv : public AbstractCNNClassifier {

public:
	CNN_aug2_full_conv(){out.open("example.txt");}

	~CNN_aug2_full_conv(){out.close();}
