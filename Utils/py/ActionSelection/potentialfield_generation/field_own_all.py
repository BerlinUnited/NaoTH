...
def main():
    ...
    x_range = range(int(-field.x_length * 0.5), int(field.x_length * 0.5) + cell_width, cell_width)
    y_range = range(int(-field.y_length * 0.5), int(field.y_length * 0.5) + cell_width, cell_width)
