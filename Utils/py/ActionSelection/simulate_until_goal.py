...
def main():
    ...
    # Todo add all the actions to the list - otherwise alway will do the wrong first action
    ...
    while True:
        ...
        expected_ball_pos = state.pose * action_list[best_action].predict(state.ball_position, True)
        state.pose.translation = expected_ball_pos
        print state.pose.translation
        draw_robot_walk(state)
