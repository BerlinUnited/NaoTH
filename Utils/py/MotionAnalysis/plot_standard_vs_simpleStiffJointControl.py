...
def init():
    ...
    file_name_prefix = "/home/steffen/NaoTH/Logs/EuropeanOpen16/2016-03-30-test-naodevils/half1/160330-1952-Nao6022"
    file_name = file_name_prefix + "/game.log"
    log0 = BehaviorParser.LogReader(file_name, parser)
    
    file_name_prefix = "/home/steffen/NaoTH/Logs/MesseLeipzig/lm15-naodevils-2/091201-0819-Nao6022"
    file_name = file_name_prefix + "/game.log"
    log1 = BehaviorParser.LogReader(file_name, parser)
