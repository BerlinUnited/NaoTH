...
_WHISTLEDATA = _descriptor.Descriptor(
  name='WhistleData',
  full_name='naothmessages.WhistleData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='naothmessages.WhistleData.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='positionInCapture', full_name='naothmessages.WhistleData.positionInCapture', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='responseValue', full_name='naothmessages.WhistleData.responseValue', index=2,
...
_WHISTLEPERCEPTDATA = _descriptor.Descriptor(
  name='WhistlePerceptData',
  full_name='naothmessages.WhistlePerceptData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='counter', full_name='naothmessages.WhistlePerceptData.counter', index=0,
      number=1, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='captureFile', full_name='naothmessages.WhistlePerceptData.captureFile', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='recognizedWhistles', full_name='naothmessages.WhistlePerceptData.recognizedWhistles', index=2,
...
_WHISTLEPERCEPTDATA.fields_by_name['recognizedWhistles'].message_type = _WHISTLEDATA
...
DESCRIPTOR.message_types_by_name['WhistleData'] = _WHISTLEDATA
DESCRIPTOR.message_types_by_name['WhistlePerceptData'] = _WHISTLEPERCEPTDATA
...
WhistleData = _reflection.GeneratedProtocolMessageType('WhistleData', (_message.Message,), dict(
  DESCRIPTOR = _WHISTLEDATA,
  __module__ = 'Framework_Representations_pb2'
  # @@protoc_insertion_point(class_scope:naothmessages.WhistleData)
  ))
_sym_db.RegisterMessage(WhistleData)

WhistlePerceptData = _reflection.GeneratedProtocolMessageType('WhistlePerceptData', (_message.Message,), dict(
  DESCRIPTOR = _WHISTLEPERCEPTDATA,
  __module__ = 'Framework_Representations_pb2'
  # @@protoc_insertion_point(class_scope:naothmessages.WhistlePerceptData)
  ))
_sym_db.RegisterMessage(WhistlePerceptData)
