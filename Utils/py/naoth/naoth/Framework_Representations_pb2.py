...
_WHISTLE = _descriptor.Descriptor(
  name='Whistle',
  full_name='naothmessages.Whistle',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='naothmessages.Whistle.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='positionInCapture', full_name='naothmessages.Whistle.positionInCapture', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='responseValue', full_name='naothmessages.Whistle.responseValue', index=2,
...
_WHISTLEPERCEPT.fields_by_name['recognizedWhistles'].message_type = _WHISTLE
...
DESCRIPTOR.message_types_by_name['Whistle'] = _WHISTLE
...
Whistle = _reflection.GeneratedProtocolMessageType('Whistle', (_message.Message,), dict(
  DESCRIPTOR = _WHISTLE,
  __module__ = 'Framework_Representations_pb2'
  # @@protoc_insertion_point(class_scope:naothmessages.Whistle)
  ))
_sym_db.RegisterMessage(Whistle)
