...
_IMAGE_FORMAT = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='YUV420_NV12', index=3, number=3,
      options=None,
      type=None),
  ],
...
_ROBOTINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='headId', full_name='naothmessages.RobotInfo.headId', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='robotName', full_name='naothmessages.RobotInfo.robotName', index=5,
...
_INERTIALSENSORDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))),
    _descriptor.FieldDescriptor(
      name='data2d', full_name='naothmessages.InertialSensorData.data2d', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='data3d', full_name='naothmessages.InertialSensorData.data3d', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HEADPOSE = _descriptor.Descriptor(
  name='HeadPose',
  full_name='naothmessages.HeadPose',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pose', full_name='naothmessages.HeadPose.pose', index=0,
      number=1, type=11, cpp_type=10, label=2,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='naothmessages.HeadPose.timestamp', index=1,
...
_INERTIALSENSORDATA.fields_by_name['data2d'].message_type = CommonTypes__pb2._DOUBLEVECTOR2
_INERTIALSENSORDATA.fields_by_name['data3d'].message_type = CommonTypes__pb2._DOUBLEVECTOR3
_BUTTONDATA_BUTTONID.containing_type = _BUTTONDATA
_HEADPOSE.fields_by_name['pose'].message_type = CommonTypes__pb2._POSE3D
...
HeadPose = _reflection.GeneratedProtocolMessageType('HeadPose', (_message.Message,), dict(
