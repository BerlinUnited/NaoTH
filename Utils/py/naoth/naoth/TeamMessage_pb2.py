...
_TEAMMESSAGE_DATA.fields_by_name['ballVelocity'].has_options = True
_TEAMMESSAGE_DATA.fields_by_name['ballVelocity']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
