...
class Ui_PlayerForm(object):
    def setupUi(self, PlayerForm):
        ...
        self.horizontalSlider = QtGui.QSlider(PlayerForm)
        self.horizontalSlider.setGeometry(QtCore.QRect(140, 70, 461, 21))
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName(_fromUtf8("horizontalSlider"))
        self.frameCounter = QtGui.QLCDNumber(PlayerForm)
        self.frameCounter.setGeometry(QtCore.QRect(540, 100, 64, 23))
