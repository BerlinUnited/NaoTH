...
mkdir('../data/capture_data_raw/go17_recordings')
mkdir('../data/capture_data_raw/rc17_recordings')

for i=1:length(go17_recordings)
    %TODO export the recordings as raw in the correct folder structure
