...
class CoMErrors; //Maybe rename to body awareness
class CoMErrorsDefaultTypeIntegral;
extern CoMErrorsDefaultTypeIntegral _CoMErrors_default_instance_;
...
// ===================================================================
class CoMErrors : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:naothmessages.CoMErrors) */ {
public:
    CoMErrors();
    virtual ~CoMErrors();

    CoMErrors(const CoMErrors& from);

    inline CoMErrors& operator=(const CoMErrors& from) {
        CopyFrom(from);
        return *this;
}
#if LANG_CXX11
    CoMErrors(CoMErrors&& from) noexcept
        : CoMErrors() {
        *this = ::std::move(from);
    }

    inline CoMErrors& operator=(CoMErrors&& from) noexcept{
        if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
            if (this != &from) InternalSwap(&from);
        }
        else {
    ...
    static const ::google::protobuf::Descriptor* descriptor();
    static const CoMErrors& default_instance();

    static inline const CoMErrors* internal_default_instance() {
        return reinterpret_cast<const CoMErrors*>(
            &_CoMErrors_default_instance_);
    }
    static PROTOBUF_CONSTEXPR int const kIndexInFileMessages =
        9;

    void Swap(CoMErrors* other);
    friend void swap(CoMErrors& a, CoMErrors& b) {
        a.Swap(&b);
    }

    // implements Message ----------------------------------------------

    inline CoMErrors* New() const PROTOBUF_FINAL{ return New(NULL); }

    CoMErrors* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
    void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
    void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
    void CopyFrom(const CoMErrors& from);
    void MergeFrom(const CoMErrors& from);
    void Clear() PROTOBUF_FINAL;
    bool IsInitialized() const PROTOBUF_FINAL;
...
private:
    ...
    void SharedDtor();
    void SetCachedSize(int size) const PROTOBUF_FINAL;
    void InternalSwap(CoMErrors* other);
private:
    inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
        return NULL;
    }
...
public:
    ...
    // @@protoc_insertion_point(class_scope:naothmessages.CoMErrors)
private:
    void set_has_data();
    void clear_has_data();
    void set_has_rawdata();
