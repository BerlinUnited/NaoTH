...
public:
  ...
  enum CompetitionType
  {
    ...
    competition_mixed   = 99 //COMPETITION_TYPE_MIXEDTEAM
  };
  ...
  enum SetPlay 
  {
    ...
    goal_free_kick    = 99, //SET_PLAY_GOAL_FREE_KICK,
  ...
  enum Penalty
  {
    ...
    illegal_defender      = 97, //PENALTY_SPL_ILLEGAL_DEFENDER,
    leaving_the_field     = PENALTY_SPL_LEAVING_THE_FIELD,
    kick_off_goal         = 98, //PENALTY_SPL_KICK_OFF_GOAL,
    request_for_pickup    = PENALTY_SPL_REQUEST_FOR_PICKUP,
    local_game_stuck      = PENALTY_SPL_LOCAL_GAME_STUCK,
    illegal_positioning   = 99, //PENALTY_SPL_ILLEGAL_POSITIONING,
