...
public:
  ...
  DATATYPE getXAngle() const
  {
        ...
        return h != static_cast<DATATYPE>(0) ? acos(this->c[2].z / h) * (this->c[2].y > 0 ? static_cast<DATATYPE>(-1) : static_cast<DATATYPE>(1)) : static_cast<DATATYPE>(0);
  }
  ...
  DATATYPE getYAngle() const
  {
        ...
        return h != static_cast<DATATYPE>(0)  ? acos(this->c[2].z / h) * (this->c[2].x > 0 ? static_cast<DATATYPE>(1) : static_cast<DATATYPE>(-1)) : static_cast<DATATYPE>(0);
  }
  ...
  DATATYPE getZAngle() const
  {
        ...
        return h != static_cast<DATATYPE>(0) ? acos(this->c[0].x / h) * (this->c[0].y < 0 ? static_cast<DATATYPE>(-1) : static_cast<DATATYPE>(1)) : static_cast<DATATYPE>(0);
  }
