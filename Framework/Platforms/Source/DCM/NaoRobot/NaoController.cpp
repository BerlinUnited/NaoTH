...
void NaoController::readNaoInfo() 
{
  ...
  // nao.info is generated by NaoSMAL or LolaAdaptor, wait if it does not exist
  while(true){
  ...
  {
    // TODO: headID is not used anywhere yet.
    std::string robotHeadID;
    is >> theBodyID >> theBodyNickName >> robotHeadID;
    cout << "[NaoController] " << "bodyID: " << theBodyID << endl;
    cout << "[NaoController] " << "bodyNickName: " << theBodyNickName << endl;
    cout << "[NaoController] " << "headID: " << robotHeadID << endl;
  }
}
