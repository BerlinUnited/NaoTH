...
const std::vector<unsigned char> ReportDefault_06A3_5F0D_0003 =
  {0x01,   // report nr ???
...
//------
const std::vector<unsigned char> ReportDefault_0079_0126_0003 =
...
sctJoypadData HIDData[3]=
{
  ...
  {"0003:000006A3:00005F0D", "Saitek P2600 Rumble Force Pad", 7, ReportDefault_06A3_5F0D_0003}, 
  {"0003:00000079:00000126", "Wireless USB Gamepad (0079/0126)", 27, ReportDefault_0079_0126_0003}
};
...
int GetJoypadConfigFromFile(sctJoypadData& rJoyData, const std::string HIDId)
{
  ...
  { // search directory for config files
    ...
    if (HIDData[ConfigFileNr].HID_Id == HIDId)
    {
      ...
      rJoyData.vInputReportDefaults.reserve(rJoyData.InputReportLen);
      rJoyData.vInputReportDefaults=HIDData[ConfigFileNr].vInputReportDefaults;
      isDataFound=1;
    }
  }
  return isDataFound;
