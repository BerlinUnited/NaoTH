...
void V4lCameraHandlerV6::initUP(unsigned int buffer_size)
{
  struct v4l2_requestbuffers req;
...
void V4lCameraHandlerV6::initRead(unsigned int buffer_size)
{
...
int V4lCameraHandlerV6::readFrameUP()
{
  cout << "#";
  //not the first frame and the buffer changed last frame
  if (wasQueried)
...
int V4lCameraHandlerV6::readFrameRead()
{
