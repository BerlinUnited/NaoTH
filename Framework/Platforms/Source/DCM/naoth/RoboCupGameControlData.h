#ifndef ROBOCUP_GAME_CONTROL_DATA
#define ROBOCUP_GAME_CONTROL_DATA
...
class ExtendedRoboCupGameControlData : public RoboCupGameControlData{
public:
  int playMode;
};
...
#endif // ROBOCUP_GAME_CONTROL_DATA