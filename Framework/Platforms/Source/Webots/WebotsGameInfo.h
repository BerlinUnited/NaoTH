/**
 * @file WebotsGameInfo.h
 *
 * @author <a href="mailto:schlottb@informatik.hu-berlin.de">Schlotter, Benjamin</a>
 * @brief the game information in SimSpark
 */

#ifndef WEBOTS_GAME_INFO_H
#define WEBOTS_GAME_INFO_H
...
public:
  ...
  static std::string getPlayModeName(WebotsGameInfo::PlayMode pm);
