/**
 * @file WebotsGameInfo.cpp
 *
 * @author <a href="mailto:schlottb@informatik.hu-berlin.de">Schlotter, Benjamin</a>
 * @brief the game information in Webots
 */

#include "WebotsGameInfo.h"
#include <iostream>
...
WebotsGameInfo::PlayMode WebotsGameInfo::getPlayModeByName(const string& name)
{
...
string WebotsGameInfo::getPlayModeName(WebotsGameInfo::PlayMode pm)
{
  switch (pm) {
...
GameData::GameState WebotsGameInfo::covertToGameState(WebotsGameInfo::PlayMode pm)
{
  switch(pm)
  {
    case PM_BEFORE_KICK_OFF:
