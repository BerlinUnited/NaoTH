...
inline void CMDArg::set_has_value() {
  _has_bits_[0] |= 0x00000002u;
}
inline void CMDArg::clear_has_value() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline ::std::string* CMDArg::release_value() {
  clear_has_value();
  if (value_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void CMDArg::set_has_value_bytes() {
  _has_bits_[0] |= 0x00000004u;
}
inline void CMDArg::clear_has_value_bytes() {
  _has_bits_[0] &= ~0x00000004u;
}
...
inline ::std::string* CMDArg::release_value_bytes() {
  clear_has_value_bytes();
  if (value_bytes_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
